...
const Welcome : React.FC = () => {
    ...
    return (
        <section className="relative flex flex-col lg:mt-12 lg:mx-[80px] md:mx-[40px] sm:mx-[30px] xs:mx-[10px] mx-8 lg:text-5xl md:text-4xl sm:text-3xl xs:text-[2.45rem] text-[2.65rem]">
            <Heading2 cls="mt-8 xs:text-xl" isNozha={false} text="با راحت بخون درساتو راحت تر بخون !" />
