...
const GameLearning : React.FC = () => {
    ...
    return (
        <section className="mb-96 grid grid-cols-12 justify-center items-center text-center lg:mt-24 mt-12 xl:mx-48 lg:mx-28 md:mx-[40px] sm:mx-[30px] xs:mx-[10px] mx-8">
            ...
            <div className="flex flex-col md:col-span-6 col-span-12">
                <Heading3 cls="!leading-relaxed xl:ml-48 lg:ml-18 md:!text-right !text-center" text={"لذت واقعی درس خوندن اینجا با بازی کردن اتفاق می افته !"} />
