...
const HomeHeader : React.FC = () => {
    ...
    return (
        <header className="flex items-center justify-center bg-[url('/images/home/drawing-by-desk.jpg')] bg-center bg-no-repeat bg-cover relative w-full h-[48rem] ">
            ...
            <WhiteWave cls="absolute xl:-bottom-[128px] lg:-bottom-[100px] md:-bottom-[70px] sm:-bottom-[50px] xs:-bottom-[25px] -bottom-[20px] scale-y-[.6] z-[3]"/>
            <PinkWave cls="absolute xl:-bottom-[116px] lg:-bottom-[90px] md:-bottom-[60px] sm:-bottom-[40px] xs:-bottom-[15px] -bottom-[12px] scale-y-[.62] z-[2]" />
        </header>
    )
}
