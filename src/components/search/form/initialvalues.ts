export const searchFormSelectboxOptions = {
    type : ["تمامی محتواها" , "کاربرگ" , "ویدیو" , "دوره" , "آزمون" , "بازی"],
    subject :  ["تمامی دروس" , "ریاضی" , "فارسی" , "علوم و آزمایشگاه" , "تاریخ و جغرافیا" , "هنر" , "درک مطلب" , "متفرقه"],
    grade :  ["تمامی پایه ها" , "اول" , "دوم"  , "سوم"  , "چهارم"  , "پنجم"  , "ششم"] ,
    rating :  ["تمامی امتیازات" , "بالاتر از 4"  , "بالاتر از 3"  , "بالاتر از 2"  , "بالاتر از 1"  , "پایین تر از 1"],
