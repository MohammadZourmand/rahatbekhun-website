                    ...
                    return (
                        item?.href
                            ?
                                ...
                                >
                                    <div className={`${item?.name.includes(defaultValue) ? 'scale-[1.10] shadow-lg border-baby-10/70 outline-baby-10' : 'border-sky-300 outline-baby-7'} lg:w-24 lg:h-24 w-[70px] h-[70px] flex items-center justify-center rounded-full outline-offset-2 border outline overflow-hidden`}>
