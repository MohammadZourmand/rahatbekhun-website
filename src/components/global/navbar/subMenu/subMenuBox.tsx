...
const SubMenuBox : React.FC<SubMenuBoxProps> = ({name, img, cls}) => {
    ...
    return (
        <Link href={"/"} className={`${cls} hover:scale-[1.15] flex flex-col col-span-4 items-center justify-center py-2 px-3 hover:bg-baby-2/30 transition-all duration-500 rounded-md`}>
