        ...
        <div className={`${cls} relative group hover:scale-105 transition-all rounded-lg bg-white shadow-md border flex flex-col xl:pt-1 xl:pb-3 xl:px-3 p-2`}>
            <div className="flex flex-row items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                    <div className={`${badgeTextColorChooser(item.category)} ${badgeBgColorChooser(item.category)} justify-self-start text-xs font-semibold px-2.5 py-[3px] rounded`}>{badgeTextTranslator(item.category)}</div>
                </div>
            </div>
