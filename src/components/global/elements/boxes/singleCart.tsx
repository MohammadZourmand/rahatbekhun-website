...
const SingleCart : React.FC<SingleCartProps> = ({
    ...
    return (
        <div className={`${cls} group flex flex-col lg:col-span-4 col-span-12 shadow-lg rounded-lg`}>
            ...
            <footer className="flex text-slate-400 text-sm px-8 pb-8">
                {
                    author && <div className="group flex items-center pl-3 border-l-2 border-slate-900">
                ...
                {
                    category && <div className="group flex items-center px-3 border-l-2 border-slate-900">
                ...
                {
                    comments && <div className="group flex items-center px-3">
                ...
                {
                    studyTime && <div className="group flex items-center px-3 border-l-2 border-slate-900">
                        <span className="ml-1"><IconClock className="transition group-hover:stroke-baby-2" color="#94a3b8" width={"20px"} /></span>
                        <span className="font-semibold transition group-hover:text-baby-2">{studyTime}</span>
                    </div>
                }                
            </footer>
        </div>
