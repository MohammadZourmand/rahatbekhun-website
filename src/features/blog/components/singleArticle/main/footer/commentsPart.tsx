...
import FiveStars from "@/components/elements/boxes/stars/fiveStars";
import BlueBtn from "@/components/form/buttons/blue";
import { courseDetails, episodeCommentsProps } from "@/components/elements/boxes/tabSwitcher/courseInfo";
